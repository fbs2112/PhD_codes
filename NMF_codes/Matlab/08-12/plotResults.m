                ...
                for numberOfTrainingCellsIndex = 1:length(numberOfTrainingCellsVector)
                    for numberOfGuardCellsIndex = 1:length(numberOfGuardCellsVector)
                        ...
                        for loopIndex = 1:monteCarloLoops
                            ...
                            fpRegion1 = auxRegion(1:onset - round(3*window_length_vector(window_length_index)/2)-1);
                            tpRegion1 = auxRegion(onset - round(3*window_length_vector(window_length_index)/2) :onset + round(7*window_length_vector(window_length_index)/2));
...
averageFP = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
averageTN = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
averageTP = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
averageFN = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));

averageTPR = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
averageFPR = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
stdTPR = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
stdFPR = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));

averageACC = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
stdACC = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
averageF1 = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
stdF1 = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
averagePrec = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
stdPrec = zeros(length(JNRVector), length(window_length_vector), length(numberOfTrainingCellsVector), length(numberOfGuardCellsVector),...
    length(NVector), length(MVector), length(alphaVector));
...
for window_median_length_index = 1:length(window_median_length_vector)
    ...
    for JNRIndex = 1:length(JNRVector)
        for thresholdIndex = 1:length(thresholdVector)
            for window_length_index = 1:length(window_length_vector)
                for numberOfTrainingCellsIndex = 1:length(numberOfTrainingCellsVector)
                    load(['results07_' num2str(numberOfTrainingCellsIndex)]);
                    for numberOfGuardCellsIndex = 1:length(numberOfGuardCellsVector)
                        for NIndex = 1:length(NVector)  
                            for MIndex = 1:length(MVector)
                                for alphaIndex = 1:length(alphaVector)
                                    
                                    fp = zeros(monteCarloLoops, 1);
                                    tp = zeros(monteCarloLoops, 1);
                                    fn = zeros(monteCarloLoops, 1);
                                    tn = zeros(monteCarloLoops, 1);
                                    detection_resAux = squeeze(aux(:, JNRIndex, 1, window_length_index, NIndex, MIndex, alphaIndex, ...
                                        1, numberOfGuardCellsIndex, 1, :));
                                    ...
                                    averageFP(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = mean(fp);
                                    averageTN(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = mean(tn);
                                    averageTP(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = mean(tp);
                                    averageFN(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = mean(fn);
                                    
                                    averageTPR(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = mean(tpr);
                                    averageFPR(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = mean(fpr);
                                    stdTPR(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = std(tpr);
                                    stdFPR(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = std(fpr);
                                    
                                    averageACC(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = mean(acc);
                                    stdACC(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = std(acc);
                                    averageF1(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = mean(f1Score);
                                    stdF1(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = std(f1Score);
                                    averagePrec(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = mean(precision);
                                    stdPrec(JNRIndex, window_length_index, numberOfTrainingCellsIndex, numberOfGuardCellsIndex, NIndex, MIndex, alphaIndex) = std(precision);
                                end
                            end
                        end
                    end
...
for i = 1:length(JNRVector)
    ...
    [maxval, maxidx] = max(averageACCAux(:));
    [j, k, l, m, n, o] = ind2sub(size(averageACCAux), maxidx);
    disp('---------------------Accuracy-----------------------------------')
    disp('------------------------------------')
    disp(['-------------JNR: ' num2str(JNRVector(i)) ' dB-----------------------'])
    disp(['Accuracy: ' num2str(maxval) '+-' num2str(stdACC(i,j,k,l,m,n,o))])
    disp('------------------------------------')
    disp(['Pd: ' num2str(averageTPR(i,j,k,l,m,n,o)) '+-' num2str(stdTPR(i,j,k,l,m,n,o))])
    disp('------------------------------------')
    disp(['Pfa: ' num2str(averageFPR(i,j,k,l,m,n,o)) '+-' num2str(stdFPR(i,j,k,l,m,n,o))])
    disp('------------------------------------')
    disp(['Var window length: ' num2str(window_length_vector(j))])
    disp('------------------------------------')
    disp(['Training cells: ' num2str(numberOfTrainingCellsVector(k))])
    ...
    disp(['Guard cells: ' num2str(numberOfGuardCellsVector(l))])
    disp('------------------------------------')
    disp(['N: ' num2str(NVector(m))])
    disp('------------------------------------')
    disp(['M: ' num2str(MVector(n))])
    disp('------------------------------------')
    disp(['Alpha: ' num2str(alphaVector(o))])
    disp('------------------------------------')
...
for i = 1:length(JNRVector)
    ...
    [maxval, maxidx] = max(averagePrecAux(:));
    [j, k, l, m, n, o] = ind2sub(size(averagePrecAux), maxidx);
    disp('---------------------Precision-----------------------------------')
    disp('------------------------------------')
    disp(['-------------JNR: ' num2str(JNRVector(i)) ' dB-----------------------'])
    disp(['Precision: ' num2str(maxval) '+-' num2str(stdPrec(i,j,k,l,m,o))])
    disp('------------------------------------')
    disp(['Pd: ' num2str(averageTPR(i,j,k,l,m,n,o)) '+-' num2str(stdTPR(i,j,k,l,m,n,o))])
    disp('------------------------------------')
    disp(['Pfa: ' num2str(averageFPR(i,j,k,l,m,n,o)) '+-' num2str(stdFPR(i,j,k,l,m,n,o))])
...
for i = 1:length(JNRVector)
    ...
    [maxval, maxidx] = max(averageF1Aux(:));
    [j, k, l, m, n, o] = ind2sub(size(averageF1Aux), maxidx);
    disp('---------------------F1-score-----------------------------------')
    disp('------------------------------------')
    disp(['-------------JNR: ' num2str(JNRVector(i)) ' dB-----------------------'])
    disp(['F1-score: ' num2str(maxval) '+-' num2str(stdF1(i,j,k,l,m,o))])
    disp('------------------------------------')
    disp(['Pd: ' num2str(averageTPR(i,j,k,l,m,n,o)) '+-' num2str(stdTPR(i,j,k,l,m,n,o))])
    disp('------------------------------------')
    disp(['Pfa: ' num2str(averageFPR(i,j,k,l,m,n,o)) '+-' num2str(stdFPR(i,j,k,l,m,n,o))])
