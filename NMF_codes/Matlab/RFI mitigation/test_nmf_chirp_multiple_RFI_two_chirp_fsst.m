...
load(['.' filesep 'data' filesep 'nmf_training_10.mat']); 
        ...
        for numberOfZerosIndex = 1:length(numberOfZerosVector)
            ...
            for JNRIndex = 1:length(paramsNMF.JNRVector)
                for i = 1:numberOfSources
                    ...
                    if ~isfield(params, 'tf') || strcmp(params.tf, 'stft')
...
save(['.' filesep 'data' filesep 'nmf_testing_22.mat'], 'xHat', 'JNRVector', '-v7.3');
