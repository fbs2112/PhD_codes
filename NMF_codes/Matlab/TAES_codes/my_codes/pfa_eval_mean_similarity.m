%This code evaluates the probability of false alarm using sample median
...
for loopIndex = 1:monteCarloLoops
    ...
    output = mean(inputNMFNormalised.'*WNormalised);
...
save(['..' filesep '..' filesep '.' filesep 'data' filesep 'TAES_data' filesep 'my_results' filesep 'results31.mat'], 'detection_res', '-v7.3');
