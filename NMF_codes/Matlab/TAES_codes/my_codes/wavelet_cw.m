           ...
           for JNRIndex = 1:length(params.JNRVector)
                ...
                for thresholdIndex = 1:length(thresholdVector)
                    for window_median_length_index = 1:length(window_median_length_vector)
                        ...
                        for wav_Index = 1:16
                            detection_res_aux(wav_Index) = any(detection_eval(wav_output(:,wav_Index), thresholdVector(thresholdIndex)));
                        end
...
save(['.' filesep 'data' filesep 'results_det_17.mat'], 'detection_res', '-v7.3');
