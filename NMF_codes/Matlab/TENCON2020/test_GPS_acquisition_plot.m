...
% xHatPaiPerf = xHatPai;
load(['.' filesep 'data' filesep 'nmf_testing_quantised_02.mat']);
...
%             GPSSignals(1,:) = xHat.';
%             GPSSignals(1,:) = xHatPai(:,JNRIndex,nbitsIndex,bandwidthIndex,loopIndex).';
...
%             GPSSignals(2,:) = mixtureSignal2(length(aux)+1:end,JNRIndex,nbitsIndex,loopIndex ).';
