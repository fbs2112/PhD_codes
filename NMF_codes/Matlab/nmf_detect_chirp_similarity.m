    ...
    for JNRIndex = 1:length(params.JNRVector)
        ...
        for thresholdIndex = 1:length(thresholdVector)
            ...
            for stdIndex = 1:length(stdVector)
                ...
                detection_res = detection_eval(outputMean, thresholdVector(thresholdIndex));
...
save(['.' filesep 'data' filesep '04-10' filesep 'results02.mat'], 'fp_sim', 'tp_sim', 'tn_sim', 'fn_sim');
