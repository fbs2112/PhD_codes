...
for loopIndex = 1:monteCarloLoops
    ...
    feature(loopIndex) = abs(freq(adsbBin));
...
save(['.' filesep 'data' filesep 'dataParkesNew' filesep  frequency filesep 'results_det_50.mat'], 'detection_res', 'thresholdVector', 'feature', '-v7.3');