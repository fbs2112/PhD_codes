...
load(['.' filesep 'DME signals' filesep 'signals_50MHz_snap_10_1s.mat']);
load(['.' filesep 'data' filesep 'W0_test_number_components_60_200.mat']);
load(['.' filesep 'data' filesep 'W0_test_number_components_SOI_60_200.mat']);
load(['.' filesep 'GPS signals' filesep 'GPS_L5.mat']);

SNR = -20;
params.JNRVector = [10 20 30 40 50];
...
monteCarloLoops = size(interferenceSignalBuffer, 2);
...
for loopIndex = 1:monteCarloLoops
    ...
    for numberOfComponentsIndex = 1:length(numberOfComponentsVector)
        ...
        params.W0 = [W{numberOfComponentsIndex,1} WSOI{numberOfComponentsIndex,1}];
...
save(['.' filesep 'data' filesep 'nmf_testing_09.mat'], 'xHat', 'mixtureSignal', 'JNRVector', 'numberOfComponentsVector');
